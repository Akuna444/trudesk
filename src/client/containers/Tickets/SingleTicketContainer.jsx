...
class SingleTicketContainer extends React.Component {
  ...
  constructor (props) {
    ...
    this.onTicketEscalation = this.onTicketEscalation.bind(this)
  ...
  onTicketEscalation () {
   api.tickets.escalatedTicket({ticketId: this.ticket._id, socketId:this.props.socket.io.engine.id}).then((res) => {
    console.log(res.assignee, "response")
    this.ticket.assignee = res.assignee
  ...
  render () {
    ...
    console.log(this.getSetting('escalateTicket'), this.props.settings.toJS(),   "is this true")
                ...
                <div className='page-content-left full-height scrollable'>
                  <div className='ticket-details-wrap uk-position-relative uk-clearfix'>
                    <div className='ticket-assignee-wrap uk-clearfix' style={{ paddingRight: 30 }}>
                      ...
                      {this.getSetting('escalateTicket')   &&  hasTicketUpdate && (<button onClick={this.onTicketEscalation} style={{ marginTop: 50 }} disabled={this.ticket.escalated} className={`btn md-btn ${this.ticket.escalated ? "uk-button uk-button-accent" : ""}`} >{this.ticket.escalated  ? "Escalated" : "Escalate"}</button>)}
                ...
                <div className='page-content-right full-height scrollable'>
                  <div className='comments-wrapper'>
                    <IssuePartial
                      ...
                      phoneNumber={this.ticket.phoneNumber}
