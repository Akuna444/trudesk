        ...
        <PageContent padding={0} paddingBottom={0} extraClass={'uk-position-relative'}>
          ...
          <Table
            ...
            headers={[
              ...
              <TableHeader key={3} width={'16%'} text={'Subject'} />,
              <TableHeader key={4} width={110} text={'Created'} />,
              <TableHeader key={10} width={110} text={'Escalated'} />,
              ...
              this.props.tickets.map(ticket => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell className={'vam nbb'}>{ticket.get("escalated") ? "Escalated" : "Not Escalated"}</TableCell>
