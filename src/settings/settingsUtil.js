  ...
  return new Promise((resolve, reject) => {
    ;(async () => {
      try {
        ...
        s.escalateTicket = parseSetting(settings, 'escalateTicket:enable', false)  // Default is false
        s.escalateTicketTime = parseSetting(settings, 'ticket:escalateTime', 40)  // Default is 40 seconds
